            ...
            <flux:navlist variant="outline">
                ...
                @if(auth()->user()->role->name === 'admin')
                    <flux:navlist.group heading="Administración" class="grid">
                        ...
                        <flux:navlist.item icon="lock-open" :href="route('admin.tables.release')" :current="request()->routeIs('admin.tables.release')" wire:navigate>Liberar Mesas</flux:navlist.item>
                    </flux:navlist.group>
                @endif
