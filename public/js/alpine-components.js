 ...
 *
 * This file is loaded as a regular (non-module) script so that the functions
 * are available on `window` BEFORE Livewire / Alpine start.  Vite's
 * `<script type="module">` is deferred and would execute too late.
 */
